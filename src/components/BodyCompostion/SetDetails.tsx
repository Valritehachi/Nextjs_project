...
const SetDetailsf: React.FC = () => {
  ...
  const { updateCaloriesLimit, updateWaterIntakeLimit } = useBodyPageActions();
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-2 pt-6">
        ...
        <div className="space-y-1">
          <Label htmlFor="waterLimit">Water Intake (ml)</Label>
          <Input
            id="waterLimit"
            type="number"
            value={waterLimit}
      ...
      <CardFooter>
        <div className="flex flex-col gap-1">
          ...
          <Button disabled={calorieLimit < 1500 || waterLimit < 1000}>
            Save changes
          </Button>
        </div>
      </CardFooter>
